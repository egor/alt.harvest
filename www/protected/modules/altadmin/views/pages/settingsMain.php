...
$this->breadcrumbs=array(
    'Гланая страница'=>array('/altadmin/pages/'),
    'Настройки',
);
?>
...
<article class="module width_full">
		...
		<ul class="tabs">
    		...
    		<li class="active"><a href="#tab2">Слайдер</a></li>
		</ul>
		</header>
...
<fieldset>    <label for="PSettings_value">Время задержки формы в слайдере (в секундах)</label>
