...
?>
<p><a href="/altadmin/stock/add/">Добавить акцию</a></p>
<article class="module width_full">
    <header><h3 class="tabs_involved">Список акций</h3>
    </header>
            ...
            <table cellspacing="0" class="tablesorter"> 
                ...
                <tbody>
                  ...
                  foreach ($model as $value) {
    				...
    				<td>                                
                                    <a href="/altadmin/stock/edit/' . $value->stock_id . '"><input type="image" title="Edit" src="/images/altadmin/icn_edit.png"></a>
                                    '.CHtml::link('<input type="image" title="Удалить" src="/images/altadmin/icn_trash.png">', array('/altadmin/stock/delete/' . $value->stock_id . ''), array('confirm'=>'Точно удалить?')).'
                                </td>				
                            </tr>';
                    }
                    ?>
